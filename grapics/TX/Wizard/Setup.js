...
//  if (installSuccess) Echo ("Внимание: Установка Автоматического обновления библиотеки TXLib отключена. "  +
//                            'Для обновления TXLib вручную запустите файл "Обновление TXLib" в папке '      +
//                            '"' + txFolder + '".'                                                          +
//                            "\n\n"                                                                         +
//                            "Warning: TXLib Automatic update setup is disabled. \n"                        +
//                            'To update TXLib, manually run file "Обновление TXLib" in folder '             +
//                            '"' + txFolder + '".', 30);
//
...
//                            "The final step is setting up TXLib Automatic Update.");
//
...
function CodeBlocks_DeleteFiles (dest)
    {
    ProcessDirTree ("", dest, DeleteTXLibH, "\\TXLib.h");
